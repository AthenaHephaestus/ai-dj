...
function draw() {
    ...
    if(scoreRightWrist > 0.2) {
        ...
        else if(rightWristY > 350 && rightWristY <= 400)
        { 
        ...
        else if(rightWristY > 450 && rightWristY <= 500)
        { 
            document.getElementById("speed").innerHTML = "Speed = 2.25";
            song.rate(2.25);
        }
    }
